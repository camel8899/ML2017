...
### parsing and Data pre-processing
	...
	sj_etr.fit(sj_train_subtrain.drop('total_cases',axis = 1),sj_train_subtrain['total_cases']) 
	...
	iq_etr.fit(iq_train_subtrain.drop('total_cases',axis = 1),iq_train_subtrain['total_cases'])
	...
	submission.total_cases = np.concatenate([[28],[25],[34],sj_predictions,[8],[6],[10],iq_predictions])
